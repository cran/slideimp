...
pca_imp_internal_cpp <- function(obj, eligible_idx, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge, solver, warmup_iters, lobpcg_tol, lobpcg_maxiter) {
    .Call(`_slideimp_pca_imp_internal_cpp`, obj, eligible_idx, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge, solver, warmup_iters, lobpcg_tol, lobpcg_maxiter)
}
